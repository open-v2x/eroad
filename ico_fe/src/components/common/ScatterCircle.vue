	...
	export default {
		...
		data() {
			return {
				optionData: [{
                    ...
                    value: 32,
                    itemStyle: {
                        color: 'rgba(23,114,255,0.8)'
                    }
                }, {
                    name: '电动自行车',
                    value: 16,
                    itemStyle: {
                        color: 'rgba(116,212,255,0.8)'
                    }
                }, {
                    name: '其他',
                    value: 23,
                    itemStyle: {
                        color: 'rgba(255,252,137,0.8)'
                    }
                }],
			}
		},
		...
		methods: {
			...
			getPie3D(pieData, internalDiameterRatio) {
				...
				let boxHeight = this.getHeight3D(series, 50);//通过传参设定3d饼/环的高度，26代表26px
