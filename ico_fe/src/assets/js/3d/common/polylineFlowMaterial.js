import materialPng from '../../../img/polylineLineFlowMaterial.png'
export const polylineFlowingMaterial = (_time) => {
  //let _time = (new Date()).getTime();
  let _color = undefined
  let duration = 3000
  const PolylineTrailLinkType = 'PolylineTrailLink'
  const PolylineTrailLinkSource = `czm_material czm_getMaterial(czm_materialInput materialInput)\n\
                                                {\n\
