...
public class DeviceStatusDTO {
    ...
    public static DeviceStatusDTO buildCameraPhysicalReport(String sn, Object data) {
        return build(sn, "camera", "physical", data);
    }

    public static DeviceStatusDTO buildNePhysicalReport(String sn, Object data) {
        return build(sn, "ne", "physical", data);
    }

    public static DeviceStatusDTO buildOltPhysicalReport(String sn, Object data) {
        return build(sn, "olt", "physical", data);
    }

    public static DeviceStatusDTO buildNeBizReport(String sn, Object data) {
        return build(sn, "ne", "biz", data);
    }

    public static DeviceStatusDTO buildOltBizReport(String sn, Object data) {
        return build(sn, "olt", "biz", data);
    }
}
